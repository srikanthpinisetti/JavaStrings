// Here are some String class methods to explore. 
//Methods like toUpperCase(),toLowerCase(),isEmpty(),startsWith(),endsWith(),length(),substring(),split(),indexOf(),trim(),replace() are discussed.
